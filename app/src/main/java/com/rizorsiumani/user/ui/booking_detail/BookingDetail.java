...
import com.rizorsiumani.user.common.AddBookingDataItem;
...
import com.rizorsiumani.user.data.businessModels.stripe.CustomerIdResponse;
import com.rizorsiumani.user.data.businessModels.stripe.EphemeralKeyResponse;
import com.rizorsiumani.user.data.businessModels.stripe.PaymentIntentResponse;
import com.rizorsiumani.user.data.local.TinyDbManager;
import com.rizorsiumani.user.databinding.ActivityBookingDetailBinding;
...
import com.rizorsiumani.user.ui.promo_code.PromoCode;
...
//
    ...
    protected void onStart() {
        ...
        if (Constants.isPayLater){
            activityBinding.btnPayLater.setVisibility(View.VISIBLE);
        }else {
            activityBinding.btnPayLater.setVisibility(View.GONE);
        }
...
//            }
        ...
        activityBinding.btnPayLater.setOnClickListener(view -> {
            ...
            try {
                if (activityBinding.tvAddress.getText().toString().equalsIgnoreCase("Please set your location")) {
